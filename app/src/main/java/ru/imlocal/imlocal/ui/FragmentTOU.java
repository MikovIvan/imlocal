...
public class FragmentTOU extends Fragment {
    public String tou_url = "https://imlocal.ru/tou_mobile.html";
    public FragmentTOU() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_tou, container, false);
        // Сообщаем о загрузке
        TextView tv = (TextView) v.findViewById(R.id.tou_text);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                // Скачать
                String html = "Ошибка при загрузке условий использования.";
                try {
                    html = downloadUrl(tou_url);
                } catch (Exception e) {
                    e.printStackTrace();
                }
